...
public class DataBasicService {
    ...
    public DbEntitySame saveOneSame() {
        ...
        return dbEntitySameService.get(DbEntitySame.class, entity.getDbEntitySameId());
    }

    public void deleteSame(DbEntitySame entity) {
        int count = dbEntitySameService.delete(DbEntitySame.class, entity.getDbEntitySameId());
    ...
    public DbEntityNotSame saveOneNotSame() {
        ...
        return dbEntityNotSameService.get(DbEntityNotSame.class, entity.getDbEntityNotSameId());
    }

    public void deleteNotSame(DbEntityNotSame entity) {
        int count = dbEntityNotSameService.delete(DbEntityNotSame.class, entity.getDbEntityNotSameId());
        Assert.assertEquals(1, count);
    }
